...
def predict_labels3_filename(X0, svrs, test_flux, test_ivar=None, mask=None,
                    flux_scaler=None, ivar_scaler=None, labels_scaler=None, file_name=None,
                    **kwargs):
    """ predict scaled labels for test_flux
    ...
    if not Path(file_name).is_file():
        ...
        pickle.dump(pp_r, open(file_name, "wb"))
    else:
        pp_r = pickle.load(open(file_name, "rb"))
